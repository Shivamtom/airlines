...
if($_SESSION['sid']==session_id())
 ...
 ?>
                          ...
                          <div id="c1">		
<form method="POST" action="adminregisterdelete.php">
<center>
						  <br>
						  <br>
<h3>	DELETE FROM REGISTER CANDIDATES-	</h3>
<hr>
<br>				  
<br><br><br><br><br>

Enter Username you want to be delete:&nbsp&nbsp&nbsp&nbsp
...
if(isset($_POST['s1']))
{
 ...
 if($c>0)
{                                                                    
  $str=mysql_query("delete from register where username='$_POST[rn]'");
  if(!$str)                                            
  {
  echo mysql_error();
  }
