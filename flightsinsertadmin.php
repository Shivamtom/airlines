...
<center>
						  <br>
<h3> ENTER NEW FLIGHTS DETAILS- </h3>
<hr>
<br>
<form method="POST" action="flightsinsertadmin.php">
<table height="40%" width="50%">
<tr>
   <td> FROM </td> 
...
<tr>
   <td> DEPART TIME </td> 
   <td><input type='time' name='a3' size='20'></td>
</tr>  
 <tr>
   <td> ARRIVAL TIME </td> 
   <td><input type='time' name='a4' size='20'></td>
</tr>
<tr>
   <td> TICKET COST </td> 
...
if(isset($_POST['s1']))
{
   ...
   {
		$sql=mysql_query("select * from fee where fromm='$_POST[a1]'");
		...
		if($c==0)
		{
			$sql=mysql_query("insert into fee values('$_POST[a1]','$_POST[a2]','$_POST[a3]','$_POST[a4]','$_POST[a5]','$_POST[a6]')");
